            ...
            <Box sx={{ flexGrow: 1, mx: { xs: 2, sm: 0 }, my: 10 }}>
                <Grid container spacing={2}>
                    ...
                    <Grid item md={5} xs={12}>
                        ...
                        <Text sx={{ my: 3, fontWeight: 400, fontSize: 18, color: "#1E3460" }}>
                        ...
                        <Box sx={{ width: '100%' }}>
                            <Button
                                ...
                                }}>Adquirir nosso Guia de Compras
                            </Button>
                        </Box>
                    </Grid>
                    <Grid item md={7} xs={12}>
                        <Box sx={{ borderRadius: 4, overflow: "hidden" }}>
                            <iframe
                                ...
                                allowFullScreen
                                style={{ minWidth: "617px", Width: "100%", minHeight: "300px", height: "auto", display: "block" }}
                            ></iframe>
                        </Box>
                    </Grid>
                </Grid>
